    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                // ----------- Success  ----------- //
                System.Console.Write("[ Client ] - Congratulation! You can now use Any Exploit for now :D, Press Any Key to Close\n", System.Console.ForegroundColor = ConsoleColor.Green);
                Console.ReadKey();
                Environment.Exit(0);
            }
            catch (Exception ex)
            {
                System.Console.Write("[ ---------------------------------------------------- ] \n", System.Console.ForegroundColor = ConsoleColor.White);
                System.Console.Write("[ Client ] - ERROR PLEASE SEND THIS TO THE DISCORD SERVER:\n\n" + ex.ToString(), System.Console.ForegroundColor = ConsoleColor.Red);
                System.Console.Write("[ ---------------------------------------------------- ] \n", System.Console.ForegroundColor = ConsoleColor.White);
                System.Console.Write("[ Client ] - Press Any Key to Close\n", System.Console.ForegroundColor = ConsoleColor.Green);
                Console.ReadKey();
                Environment.Exit(0);
            }
